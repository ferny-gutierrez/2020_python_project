...
from page_objects.search_job_page import SearchJobPage
...
class HomePage(BasePageObject):
    def __init__(self, driver: webdriver, timeout: int = 10):
        ...
        # self.__learn_more_locator = (By.PARTIAL_LINK_TEXT, 'Learn more')
    ...
    # def learn_more(self):
    #     link = self.wait.until(EC.visibility_of_element_located(self.__learn_more_locator))
    #     link.click()
