...
class SearchJobPage(BasePageObject):
    def __init__(self, driver: webdriver, timeout: int = 10):
        ...
        self.__titles_locator = (By.XPATH, "//*[@name='keywords' and @aria-label='Buscar cargos o empresas']")
        self.__location_locator = (By.XPATH, "//*[@name='location' and @aria-label='Ubicación']")
